...
namespace whi_nav2_bt_actions_server
{
	...
	Status SpinToPath::onRun(const std::shared_ptr<const SpinToPathAction::Goal> Command)
	{
		...
		cmd_yaw_ = Command->lookahead_distance; // TODO
		RCLCPP_INFO(
	...
	bool SpinToPath::isCollisionFree(const double &relative_yaw,
		geometry_msgs::msg::Twist *cmd_vel, geometry_msgs::msg::Pose2D &pose2d)
	{
